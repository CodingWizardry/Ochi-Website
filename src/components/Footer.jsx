function Footer() {
  return (
    <div className="w-full h-screen flex overflow-hidden bg-zinc-300">
      <div className="w-1/2 h-full flex flex-col justify-between px-20 py-10">
        <h1 className="text-[6vw] leading-none tracking-tighter uppercase font-bold">
          eye-
          <br />
          opening
        </h1>
      ...
      <div className="w-1/2 px-20 py-10">
        ...
        <div className=" pt-[7%]">
          ...
          <br /> <br />
          <a href="#">
            <p className="underline capitalize">hello@ochi.design</p>{" "}
          </a>
        </div>
        <div className="flex justify-between w-full mt-10">
          <p className="text-[#777777]">
            &copy; ochi design 2024.{" "}
            <span className="underline capitalize">legal terms</span>
          </p>
          <p className="text-[#777777]">Website by Mudit</p>
        </div>
      </div>
    </div>
  );
